    ...
    <div class="flex items-center justify-between py-[10px]">
      ...
      <div class="flex items-center gap-[4px]">
        <For each={props.shortcut.keys}>
          {(key) => (
            <kbd class="inline-flex items-center justify-center min-w-[24px] h-[24px] px-[6px] rounded-[4px] bg-surface border border-border text-[10px] font-mono font-semibold text-muted">
              {key}
            </kbd>
          )}
        </For>
